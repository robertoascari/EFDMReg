...
namespace model_FDM2_namespace {
...
static constexpr std::array<const char*, 103> locations_array__ =
  ...
  " (in 'string', line 93, column 2 to column 12)",
  " (in 'string', line 94, column 2 to column 13)",
  ...
  " (in 'string', line 98, column 2 to column 13)",
  " (in 'string', line 99, column 2 to column 14)",
  " (in 'string', line 102, column 4 to column 52)",
  " (in 'string', line 101, column 15 to line 103, column 3)",
  " (in 'string', line 101, column 2 to line 103, column 3)",
  " (in 'string', line 106, column 3 to column 80)",
  " (in 'string', line 107, column 3 to column 86)",
  " (in 'string', line 109, column 3 to column 80)",
  " (in 'string', line 110, column 3 to column 183)",
  " (in 'string', line 105, column 15 to line 111, column 3)",
  " (in 'string', line 105, column 2 to line 111, column 3)",
  " (in 'string', line 112, column 2 to column 59)",
  " (in 'string', line 92, column 16 to line 113, column 2)",
  " (in 'string', line 92, column 1 to line 113, column 2)",
  " (in 'string', line 51, column 1 to column 33)",
  " (in 'string', line 53, column 2 to column 32)",
  " (in 'string', line 55, column 2 to column 23)",
  " (in 'string', line 61, column 3 to column 38)",
  " (in 'string', line 60, column 17 to line 62, column 3)",
  " (in 'string', line 60, column 2 to line 62, column 3)",
  " (in 'string', line 59, column 20 to line 63, column 2)",
  " (in 'string', line 59, column 1 to line 63, column 2)",
  " (in 'string', line 67, column 2 to column 12)",
  " (in 'string', line 68, column 2 to column 13)",
  ...
  " (in 'string', line 72, column 2 to column 13)",
  " (in 'string', line 73, column 2 to column 14)",
  " (in 'string', line 76, column 4 to column 52)",
  " (in 'string', line 75, column 15 to line 77, column 3)",
  " (in 'string', line 75, column 2 to line 77, column 3)",
  " (in 'string', line 80, column 3 to column 80)",
  " (in 'string', line 81, column 3 to column 86)",
  " (in 'string', line 83, column 3 to column 80)",
  " (in 'string', line 84, column 3 to column 183)",
  " (in 'string', line 79, column 15 to line 85, column 3)",
  " (in 'string', line 79, column 2 to line 85, column 3)",
  " (in 'string', line 86, column 4 to column 58)",
  " (in 'string', line 66, column 16 to line 87, column 2)",
  " (in 'string', line 66, column 1 to line 87, column 2)",
...
class model_FDM2 final : public model_base_crtp<model_FDM2> {
private:
  int N;
  int D;
  std::vector<int> n;
...
public:
  ~model_FDM2() {}
  model_FDM2(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_FDM2_namespace::model_FDM2";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = (beta_raw_1dim__ * K) + 1 + (D - 1) + 1;
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      local_scalar_t__ w_norm = DUMMY_VAR__;
      current_statement__ = 4;
      w_norm = in__.template read_constrain_lub<local_scalar_t__,
                 jacobian__>(0, 1, lp__);
      ...
      }
      {
        ...
        lp_accum__.add(stan::math::beta_lpdf<propto__>(w_norm, 30, 30));
        ...
        for (int i = 1; i <= N; ++i) {
          ...
          for (int j = 1; j <= D; ++j) {
            ...
            stan::model::assign(tau, (aplus * ((w_norm *
              stan::math::fmin(1.0,
                (stan::model::rvalue(mu, "mu", stan::model::index_uni(i),
                   stan::model::index_uni(j)) /
                stan::model::rvalue(p, "p", stan::model::index_uni(j))))) /
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_FDM2_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      p = in__.template read_constrain_simplex<
            Eigen::Matrix<local_scalar_t__,-1,1>, jacobian__>(lp__, D);
      double w_norm = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 4;
      w_norm = in__.template read_constrain_lub<local_scalar_t__,
                 jacobian__>(0, 1, lp__);
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      local_scalar_t__ w_norm = DUMMY_VAR__;
      current_statement__ = 4;
      w_norm = in__.read<local_scalar_t__>();
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      ...
      local_scalar_t__ w_norm = DUMMY_VAR__;
      current_statement__ = 4;
      w_norm = context__.vals_r("w_norm")[(1 - 1)];
      out__.write_free_lub(0, 1, w_norm);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(beta_raw_1dim__) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"aplus\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"p\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(D) + "},\"block\":\"parameters\"},{\"name\":\"w_norm\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(D) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(D) + "},\"block\":\"transformed_parameters\"},{\"name\":\"logits\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(D) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(beta_raw_1dim__) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"aplus\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"p\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string((D -1)) + "},\"block\":\"parameters\"},{\"name\":\"w_norm\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(D) + ",\"cols\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(D) + "},\"block\":\"transformed_parameters\"},{\"name\":\"logits\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(N) + ",\"cols\":" + std::to_string(D) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((((beta_raw_1dim__ * K) + 1) + D) + 1);
...
using stan_model = model_FDM2_namespace::model_FDM2;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_FDM2_namespace::profiles__;
}
#endif
#endif
