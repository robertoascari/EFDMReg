...
#include "stanExports_EFDM_hyper_w.h"

RCPP_MODULE(stan_fit4EFDM_hyper_w_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_EFDM_hyper_w")
